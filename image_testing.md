# Image Integration Testing Playbook (for testing agents)
...
- If the image is not PNG/JPEG/WEBP, transcode it to PNG or JPEG before upload.
  - Fix example: If you read a .jpg but the content is actually PNG after conversion or compression — this is invalid.
